...
class Test(unittest.TestCase):
    ...
    def test_read_three_digit_number(self):
        self.assertEquals(['one', 'hundred', 'twenty','three'], self.numberReader.convertNumberToString(123))

    def test_read_three_digit_number_with_teen(self):
        self.assertEquals(['one', 'hundred', 'eleven'], self.numberReader.convertNumberToString(111))
